...
/***/ function(module, exports, __webpack_require__) {
	...
	var Adapter, BrowserAdapter, Connection, Ndex, WorkerAdapter, expect, ref, simple;

	Ndex = __webpack_require__(24);

	Connection = __webpack_require__(20);

	Adapter = __webpack_require__(21);

	BrowserAdapter = __webpack_require__(22);

	WorkerAdapter = __webpack_require__(23);

	ref = __webpack_require__(18), simple = ref.simple, expect = ref.expect;

	describe('Ndex', function() {
	  describe('#connect', function() {
	    it('returns a connection promise', function() {
	      var promise;
	      promise = Ndex.connect('foo', __webpack_require__(68));
	      expect(promise).to.be.an["instanceof"](Promise);
	      return expect(promise).to.eventually.be.an["instanceof"](Adapter);
	    });
	    it('handles multiple connection', function(done) {
	      var connection1, connection2, promises;
	      promises = [];
	      connection1 = null;
	      connection2 = null;
	      promises.push(Ndex.connect('connection1', {}).then(function(connection) {
	        return connection1 = connection;
	      }));
	      promises.push(Ndex.connect('connection2', {}).then(function(connection) {
	    ...
	    return describe('when trying to connect to the same database twice', function() {
	      return it('rejects the connection promise', function() {
	        expect(Ndex.connect('foo', {})).to.be.fulfilled;
	        return expect(Ndex.connect('foo', {})).to.be.rejectedWith('Already connected to “foo”');
	      });
	    });
	  });
	  describe('#getAdapter', function() {
	    beforeEach(function() {
	      return this.connection = new Connection('foo', {});
	    });
	    describe('when workers are supported', function() {
	      beforeEach(function() {
	        return simple.mock(Ndex, 'workersAreSupported', function() {
	          return true;
	        });
	      });
	      return it('returns WorkerAdapter instance', function() {
	        var adapter;
	        adapter = Ndex.getAdapter(this.connection);
	        return expect(adapter).to.be.an["instanceof"](WorkerAdapter);
	      });
	    });
	    return describe('when workers are not supported', function() {
	      beforeEach(function() {
	        return simple.mock(Ndex, 'workersAreSupported', function() {
	          return false;
	        });
	      });
	      return it('returns BrowserAdapter instance', function() {
	        var adapter;
	        adapter = Ndex.getAdapter(this.connection);
	        return expect(adapter).to.be.an["instanceof"](BrowserAdapter);
	      });
	    });
	  });
	  describe('#getAdapterClass', function() {
	    describe('when workers are supported', function() {
	      beforeEach(function() {
	        return simple.mock(Ndex, 'workersAreSupported', function() {
	          return true;
	      ...
	      return it('returns WorkerAdapter class', function() {
	        var adapterClass;
	        adapterClass = Ndex.getAdapterClass();
	        return expect(adapterClass).to.equal(WorkerAdapter);
	      });
	    });
	    return describe('when workers are not supported', function() {
	      beforeEach(function() {
	      ...
	      return it('returns BrowserAdapter class', function() {
	        var adapterClass;
	        adapterClass = Ndex.getAdapterClass();
	        return expect(adapterClass).to.equal(BrowserAdapter);
	      });
	    });
	  });
	  return describe('#workersAreSupported', function() {
	    afterEach(function() {
	      return delete Ndex._workersAreSupported;
	    });
	    describe('when workers are supported', function() {
	      return it('returns true', function() {
	        return expect(Ndex.workersAreSupported({
	          Worker: true
	        })).to.be["true"];
	      });
	    });
	    return describe('when workers are not supported', function() {
	      return it('returns false', function() {
	        return expect(Ndex.workersAreSupported({})).to.be["false"];
	      });
	    });
	  });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BrowserAdapter, Connection, Ndex, WorkerAdapter, delay, expect, helpers, ref, simple;
	...
	ref = __webpack_require__(18), simple = ref.simple, expect = ref.expect, helpers = ref.helpers;
	...
	describe('Connection', function() {
	  describe('Migrations', function() {
	    ...
	    it('sorts migrations by key', function() {
	      var migrations;
	      migrations = this.connection.parseMigrations({
	        54321: (function() {}),
	        12345: (function() {})
	      });
	      return expect(migrations.map(function(m) {
	        return m.key;
	      })).to.deep.equal(['12345', '54321']);
	    });
	    it('parses migrations', function() {
	      var expected, i, j, len, migration, migrations, results;
	      migrations = this.connection.parseMigrations({
	        '54321_CreateFooBar': (function() {}),
	        '12345_CreateBarFoo': (function() {})
	      });
	      expected = [
	        {
	          version: 12345,
	          title: "Create bar foo",
	          key: "12345_CreateBarFoo"
	        }, {
	          version: 54321,
	          title: "Create foo bar",
	          key: "54321_CreateFooBar"
	        }
	      ];
	      results = [];
	      for (i = j = 0, len = migrations.length; j < len; i = ++j) {
	        ...
	        results.push(expect(migration).to.have.deep.property('key', expected[i].key));
	      }
	      return results;
	    });
	    return it('creates a namespace for object stores', function() {
	      simple.mock(this.connection, 'add', function() {});
	      expect(this.connection.foozle).not.to.exist;
	      this.connection.createNamespaceForObjectStore('foozle');
	      expect(this.connection.foozle).to.exist;
	      this.connection.foozle.add({
	        foo: 'bar'
	      });
	      return expect(this.connection.add.firstCall.args).to.deep.equal([
	        'foozle', {
	          foo: 'bar'
	        }
	      ]);
	  ...
	  describe('Requests', function() {
	    beforeEach(function() {
	      this.connection = new Connection('foo', {});
	      return simple.mock(this.connection, 'createTransaction', function() {});
	    });
	    describe('Queue', function() {
	      it('enqueues requests', function() {
	        var i, j;
	        simple.mock(this.connection, 'scheduleTransaction', function() {});
	        for (i = j = 1; j <= 5; i = ++j) {
	          this.connection.enqueue('write', 'foo');
	        }
	        return expect(this.connection.queue.foo.length).to.equal(5);
	      });
	      it('clears requests on event loop', function(done) {
	        var i, j;
	        for (i = j = 1; j <= 5; i = ++j) {
	          this.connection.enqueue('write', 'foo');
	        }
	        expect(this.connection.queue.foo.length).to.equal(5);
	        return delay(0, done, (function(_this) {
	          return function() {
	            return expect(_this.connection.queue.foo.length).to.equal(0);
	          };
	        })(this));
	      });
	      return it('schedules 1 transaction per event loop', function(done) {
	        simple.mock(this.connection, 'scheduleTransaction');
	        this.connection.enqueue('read', 'foo');
	        this.connection.enqueue('write', 'foo');
	        delay(0, (function(_this) {
	          return function() {
	            _this.connection.enqueue('read', 'foo');
	            return _this.connection.enqueue('write', 'foo');
	          };
	        })(this));
	        return delay(1, done, (function(_this) {
	          return function() {
	            return expect(_this.connection.scheduleTransaction.calls.length).to.equal(2);
	          };
	        })(this));
	      });
	    });
	    return describe('Transaction', function() {
	      it('handles readonly', function(done) {
	        this.connection.enqueue('read', 'foo');
	        this.connection.enqueue('read', 'bar');
	        return delay(0, done, (function(_this) {
	          return function() {
	            return expect(_this.connection.createTransaction.firstCall.args[0]).to.equal('readonly');
	          };
	        })(this));
	      });
	      it('handles readwrite', function(done) {
	        this.connection.enqueue('read', 'foo');
	        this.connection.enqueue('write', 'foo');
	        return delay(0, done, (function(_this) {
	          return function() {
	            return expect(_this.connection.createTransaction.firstCall.args[0]).to.equal('readwrite');
	          };
	        })(this));
	      });
	      return it('creates 1 transaction per objectStore', function(done) {
	        this.connection.enqueue('read', 'foo');
	        this.connection.enqueue('write', 'foo');
	        this.connection.enqueue('read', 'bar');
	        this.connection.enqueue('write', 'bar');
	        return delay(0, done, (function(_this) {
	          return function() {
	            return expect(_this.connection.createTransaction.calls.length).to.equal(2);
	          };
	        })(this));
	      });
	    });
	  ...
	  return describe('Methods', function() {
	    return [BrowserAdapter, WorkerAdapter].forEach(function(AdapterClass) {
	      return describe(AdapterClass.name, function() {
	        beforeEach(function(done) {
	          var adapter, connection;
	          connection = new Connection('foo', __webpack_require__(68));
	          adapter = new AdapterClass(connection);
	          return adapter.handleMethod('open').then((function(_this) {
	            return function(objectStoreNames) {
	              adapter.proxyObjectStoresNamespace(objectStoreNames);
	              _this.connection = adapter;
	              return _this.connection.clearAll().then(function() {
	                return Promise.all([
	                  _this.connection.add('users', {
	                    name: 'e',
	                    job: 'developer',
	                    id: 1
	                  }), _this.connection.add('users', {
	        ...
	        describe('#get', function() {
	          it('gets an item', function() {
	            var promise;
	            promise = this.connection.get('users', 2);
	          ...
	          return it('gets multiple items', function() {
	            var promise;
	            promise = this.connection.users.get([1, 3]);
	            return expect(promise).to.eventually.deep.equal([
	              {
	                name: 'e',
	                job: 'developer',
	        ...
	        describe('#getAll', function() {
	          return it('returns all items', function() {
	            var promise;
	            promise = this.connection.getAll('users');
	            return expect(promise).to.eventually.deep.equal([
	              {
	                name: 'e',
	                job: 'developer',
	        ...
	        describe('#add', function() {
	          describe('with a key', function() {
	            it('adds an item', function() {
	              this.connection.add('organizations', 'heliom', {
	                name: 'heliom'
	              });
	              return expect(this.connection.organizations.get('heliom')).to.eventually.deep.equal({
	                name: 'heliom'
	              });
	            });
	            return it('adds multiple items', function() {
	              this.connection.add('organizations', ['heliom', 'abrico'], [
	                {
	                  name: 'heliom'
	                }, {
	                  name: 'abrico'
	              ...
	              expect(this.connection.organizations.get('heliom')).to.eventually.deep.equal({
	                name: 'heliom'
	              });
	              return expect(this.connection.organizations.get('abrico')).to.eventually.deep.equal({
	                name: 'abrico'
	              });
	            });
	          });
	          return describe('without a key', function() {
	            it('adds an item', function() {
	              this.connection.add('users', {
	                name: 'foo',
	                id: 5
	              });
	              return expect(this.connection.users.get(5)).to.eventually.deep.equal({
	                name: 'foo',
	                id: 5
	              });
	            });
	            return it('adds multiple items', function() {
	              ...
	              expect(this.connection.users.get(1)).to.eventually.deep.equal({
	                foo: 'bar1',
	                id: 1
	              });
	              return expect(this.connection.users.get(2)).to.eventually.deep.equal({
	                foo: 'bar2',
	                id: 2
	              });
	            });
	        ...
	        describe('#update', function() {
	          describe('with a key', function() {
	            it('updates received params', function() {
	              this.connection.organizations.add('missive', {
	                est: 2014
	              });
	              expect(this.connection.organizations.get('missive')).to.eventually.deep.equal({
	                est: 2014
	              });
	              this.connection.organizations.add('missive', {
	                name: 'missive'
	              ...
	              return this.connection.organizations.update('missive', {
	                est: 2014
	              }).then((function(_this) {
	                return function() {
	                  var promise;
	                  promise = _this.connection.organizations.get('missive');
	                  return expect(promise).to.eventually.deep.equal({
	                    name: 'missive',
	                    est: 2014
	                  });
	            ...
	            it('inserts a new entry', function() {
	              expect(this.connection.organizations.get('missive')).to.eventually.be["null"];
	              return this.connection.organizations.update('missive', {
	                name: 'missive'
	              }).then((function(_this) {
	                return function() {
	            ...
	            return it('deeply updates object attributes', function() {
	              this.connection.organizations.add('missive', {
	                name: 'missive',
	                employees: {
	                  count: 3,
	          ...
	          return describe('without a key', function() {
	            it('updates received params', function() {
	              this.connection.users.add({
	                id: 1337,
	                name: 'Frodo'
	              });
	              expect(this.connection.users.get(1337)).to.eventually.deep.equal({
	                id: 1337,
	                name: 'Frodo'
	              });
	              this.connection.users.add({
	              ...
	              return this.connection.users.update(1337, {
	                name: 'Frodo'
	              }).then((function(_this) {
	                return function() {
	                  var promise;
	                  promise = _this.connection.users.get(1337);
	                  return expect(promise).to.eventually.deep.equal({
	                    id: 1337,
	                    name: 'Frodo',
	                    job: 'Ring-bearer'
	            ...
	            it('inserts a new entry', function() {
	              expect(this.connection.users.get(1337)).to.eventually.be["null"];
	              return this.connection.users.update(1337, {
	                name: 'Frodo'
	              }).then((function(_this) {
	        ...
	        describe('#increment', function() {
	          describe('with a key', function() {
	            it('increments the entry', function() {
	              this.connection.organizations.add('foo', 5);
	              return this.connection.organizations.increment('foo').then((function(_this) {
	                return function() {
	                  var promise;
	                  promise = _this.connection.organizations.get('foo');
	                  return expect(promise).to.eventually.equal(6);
	                };
	              })(this));
	            });
	            return it('initializes attribute to zero if null', function() {
	              return this.connection.organizations.increment('foo').then((function(_this) {
	                return function() {
	                  var promise;
	                  promise = _this.connection.organizations.get('foo');
	          ...
	          return describe('without a key', function() {
	            it('increments an object attribute', function() {
	              this.connection.users.add({
	                id: 100,
	                count: 5
	              });
	              return this.connection.users.increment(100, {
	                count: 4
	              }).then((function(_this) {
	                return function() {
	                  var promise;
	                  promise = _this.connection.users.get(100);
	                  return expect(promise).to.eventually.deep.equal({
	                    id: 100,
	                    count: 9
	                  });
	            ...
	            it('deeply increments multiple object attributes', function() {
	              this.connection.users.add({
	                id: 100,
	                count: 1,
	                foo: {
	        ...
	        describe('#decrement', function() {
	          describe('with a key', function() {
	            it('increments the entry', function() {
	              this.connection.organizations.add('foo', 5);
	              return this.connection.organizations.decrement('foo').then((function(_this) {
	                return function() {
	                  var promise;
	                  promise = _this.connection.organizations.get('foo');
	          ...
	          return describe('without a key', function() {
	            it('increments an object attribute', function() {
	              ...
	              return this.connection.users.decrement(100, {
	                count: 4
	              }).then((function(_this) {
	                return function() {
	                  var promise;
	        ...
	        describe('#delete', function() {
	          it('removes an item', function() {
	            this.connection.users["delete"](2);
	            return expect(this.connection.users.getAll()).to.eventually.deep.equal([
	              {
	                name: 'e',
	                job: 'developer',
	                id: 1
	          ...
	          return it('removes multiple items', function() {
	            this.connection.users["delete"]([1, 3]);
	            return expect(this.connection.users.getAll()).to.eventually.deep.equal([
	              {
	                name: 'r',
	                job: 'developer',
	        ...
	        describe('#clear', function() {
	          return it('clears an objectStore', function() {
	            this.connection.users.clear();
	            return expect(this.connection.users.getAll()).to.eventually.deep.equal([]);
	          });
	        });
	        describe('#clearAll', function() {
	          return it('clears all objectStores', function() {
	            this.connection.users.add({
	              foo: 'bar'
	            });
	            this.connection.organizations.add('bar', {
	              name: 'bar'
	            });
	            this.connection.clearAll();
	            expect(this.connection.users.getAll()).to.eventually.deep.equal([]);
	            return expect(this.connection.organizations.getAll()).to.eventually.deep.equal([]);
	          });
	        });
	        describe('#reset', function() {
	          return it('clears an objectStore and adds items', function(done) {
	            return this.connection.users.reset({
	              name: 'm',
	              job: 'janitor',
	              id: 5
	            }).then((function(_this) {
	              return function() {
	                return _this.connection.users.getAll().then(function(data) {
	        ...
	        describe('#index', function() {
	          it('#get', function() {
	            var promise;
	            promise = this.connection.users.index('job').get('designer');
	            return expect(promise).to.eventually.deep.equal({
	              name: 't',
	              job: 'designer',
	              id: 4
	          ...
	          it('#getAll', function() {
	            var promise;
	            promise = this.connection.users.index('job').getAll();
	            return expect(promise).to.eventually.deep.equal([
	              {
	                name: 't',
	                job: 'designer',
	          ...
	          return it('#where', function() {
	            var promise;
	            promise = this.connection.users.index('job').where({
	              limit: 1,
	              offset: 2
	            });
	            return expect(promise).to.eventually.deep.equal([
	        ...
	        return describe('#where', function() {
	          describe(':lt', function() {
	            return it('returns all items lower than', function() {
	              var promise;
	              promise = this.connection.users.where({
	                lt: 3
	              });
	              return expect(promise).to.eventually.deep.equal([
	                {
	          ...
	          describe(':lteq', function() {
	            return it('returns all items lower or equal to', function() {
	              var promise;
	              promise = this.connection.users.where({
	                lteq: 3
	              });
	          ...
	          describe(':gt', function() {
	            return it('returns all items greater than', function() {
	              var promise;
	              promise = this.connection.users.where({
	                gt: 3
	              });
	          ...
	          describe(':gteq', function() {
	            return it('returns all items greater or equal to', function() {
	              var promise;
	              promise = this.connection.users.where({
	                gteq: 3
	              });
	          ...
	          describe(':eq', function() {
	            it('returns all items equal to', function() {
	              var promise;
	              promise = this.connection.users.where({
	                eq: 1
	              });
	            ...
	            return it('merges :only when an array', function() {
	              var promise;
	              promise = this.connection.users.where({
	                eq: [1, 4],
	                only: {
	          ...
	          describe(':limit', function() {
	            it('limits to a number', function() {
	              var promise;
	              promise = this.connection.users.where({
	                limit: 2
	              });
	            ...
	            return it('limits to a truthy function', function() {
	              var limit, promise;
	              if (this.connection instanceof WorkerAdapter) {
	                return;
	              }
	              limit = function(data) {
	          ...
	          describe(':offset', function() {
	            return it('offsets the items', function() {
	              var promise;
	              promise = this.connection.users.where({
	                offset: 2
	              });
	          ...
	          describe(':only', function() {
	            return it('returns items matching only', function() {
	              var promise;
	              promise = this.connection.users.where({
	                only: {
	                  job: 'developer'
	          ...
	          describe(':except', function() {
	            return it('returns items except matching', function() {
	              var promise;
	              promise = this.connection.users.where({
	                except: {
	                  job: 'developer'
	          ...
	          describe(':uniq', function() {
	            return it('returns only 1 item per uniq', function() {
	              var promise;
	              promise = this.connection.users.where({
	                uniq: 'job'
	              });
	          ...
	          describe(':order', function() {
	            return it('returns items in desc order', function() {
	              var promise;
	              promise = this.connection.users.where({
	                order: 'desc'
	              });
	          ...
	          return describe(':remove', function() {
	            it('creates a write transaction', function() {
	              if (this.connection instanceof WorkerAdapter) {
	                return;
	              }
	              simple.mock(this.connection.connection, 'enqueue');
	              this.connection.users.where({
	                eq: 1,
	                remove: true
	              });
	              return expect(this.connection.connection.enqueue.firstCall.args[0]).to.equal('write');
	            });
	            return it('removes items from indexedDB', function() {
	              return this.connection.users.index('job').where({
	                eq: 'developer',
	                remove: true
	              }).then((function(_this) {
	                return function(data) {
	                  var promise;
	                  promise = _this.connection.users.index('job').where({
	                    eq: 'developer'
	                  });
	                  return expect(promise).to.eventually.deep.equal([]);
	                };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Adapter, Connection, expect, ref, simple;
	...
	describe('Adapter', function() {
	  beforeEach(function() {
	    this.connection = new Connection('foo', {});
	    return this.adapter = new Adapter(this.connection);
	  });
	  it('defines connection API methods', function() {
	    var connectionMethods, i, k, len, method, results, v;
	    connectionMethods = (function() {
	      var ref1, results;
	      ref1 = this.connection;
	      results = [];
	      for (k in ref1) {
	        v = ref1[k];
	    ...
	    results = [];
	    for (i = 0, len = connectionMethods.length; i < len; i++) {
	      method = connectionMethods[i];
	      results.push(expect(this.adapter[method]).to.be.defined);
	    }
	    return results;
	  });
	  it('defines object stores namespace', function() {
	    var i, len, method, ref1, results;
	    this.adapter.proxyObjectStoresNamespace(['foo', 'bar']);
	    expect(this.adapter.foo).to.be.defined;
	    ref1 = this.connection.getMethodsForObjectStore();
	    results = [];
	    for (i = 0, len = ref1.length; i < len; i++) {
	      method = ref1[i];
	      results.push(expect(this.adapter.foo[method]).to.be.defined);
	    }
	    return results;
	  });
	  it('defines index methods', function() {
	    var methods;
	    methods = this.adapter.index('foo', 'bar');
	    return expect(Object.keys(methods)).to.deep.equal(this.connection.getMethodsForIndex());
	  });
	  return describe('#handleMethod', function() {
	    beforeEach(function() {
	      return simple.mock(this.adapter, 'handleMethod', function() {});
	    });
	    return it('proxy connection', function() {
	      this.adapter.add('foo', {
	        id: 1
	      });
	      expect(this.adapter.handleMethod.calls.length).to.equal(1);
	      expect(this.adapter.handleMethod.calls[0].args).to.deep.equal([
	        'add', 'foo', {
	          id: 1
	        }
	      ]);
	      this.adapter.index('foo', 'bar').get({
	        id: 1
	      });
	      expect(this.adapter.handleMethod.calls.length).to.equal(2);
	      return expect(this.adapter.handleMethod.calls[1].args).to.deep.equal([
	        'get', 'foo', {
	          id: 1
	        }, 'bar'
	      ]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BrowserAdapter, Connection, expect, ref, simple;
	...
	describe('BrowserAdapter < Adapter', function() {
	  beforeEach(function() {
	    this.connection = new Connection('foo', {});
	    return this.adapter = new BrowserAdapter(this.connection);
	  });
	  return describe('#handleMethod', function() {
	    beforeEach(function() {
	      return simple.mock(this.connection, 'open', function() {});
	    });
	    return it('relays to connection', function() {
	      this.adapter.open();
	      return expect(this.connection.open.calls.length).to.equal(1);
	    });
	  });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Connection, WorkerAdapter, expect, ref, simple;
	...
	describe('WorkerAdapter < Adapter', function() {
	  beforeEach(function() {
	    simple.mock(Worker.prototype, 'postMessage', function() {});
	    this.connection = new Connection('foo', {
	      foo_migration: function() {
	        return this.doSomething();
	      }
	    });
	    return this.adapter = new WorkerAdapter(this.connection);
	  });
	  describe('Worker', function() {
	    it('spawns a worker on initialization', function() {
	      return expect(this.adapter.worker).to.be.an["instanceof"](Worker);
	    });
	    it('init worker with db name and migrations', function() {
	      var args;
	      expect(this.adapter.worker.postMessage.calls.length).to.equal(1);
	      args = this.adapter.worker.postMessage.firstCall.args[0];
	      ...
	      return expect(args).to.have.deep.property('args.migrations');
	    });
	    return it('transfers migrations function as string', function() {
	      var args;
	      args = this.adapter.worker.postMessage.firstCall.args[0];
	      return expect(args.args.migrations).to.deep.equal({
	        foo_migration: 'function () { return this.doSomething(); }'
	      });
	    });
	  });
	  describe('#handleMethod', function() {
	    it('#postMessage to worker', function() {
	      this.adapter.open();
	      expect(this.adapter.worker.postMessage.calls.length).to.equal(2);
	      expect(this.adapter.worker.postMessage.calls[1].args).to.deep.equal([
	        {
	          id: 1,
	          method: 'open',
	          args: []
	      ...
	      this.adapter.get('foo', 1);
	      expect(this.adapter.worker.postMessage.calls.length).to.equal(3);
	      return expect(this.adapter.worker.postMessage.calls[2].args).to.deep.equal([
	        {
	          id: 2,
	          method: 'get',
	          args: ['foo', 1]
	    ...
	    return it('caches promises’ resolve/reject functions', function() {
	      var i, j, length, ref1, results;
	      length = Object.keys(this.adapter.promises).length;
	      ...
	      results = [];
	      for (i = j = 1, ref1 = length; 1 <= ref1 ? j <= ref1 : j >= ref1; i = 1 <= ref1 ? ++j : --j) {
	        expect(this.adapter.promises[i]).to.be.defined;
	        expect(this.adapter.promises[i].id).to.equal(i);
	        expect(this.adapter.promises[i].resolve).to.be.defined;
	        results.push(expect(this.adapter.promises[i].reject).to.be.defined);
	      }
	      return results;
	    });
	  });
	  return describe('#handleMessage', function() {
	    it('resolves promise when worker response is resolved', function() {
	      var length, promise;
	      promise = this.adapter.open();
	      length = Object.keys(this.adapter.promises).length;
	    ...
	    return it('rejects promise when worker response is rejected', function() {
	      var length, promise;
	      promise = this.adapter.open();
	      length = Object.keys(this.adapter.promises).length;
	      expect(length).to.equal(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		module.hot.accept("!!/Users/etiennelem/Code/new_ndex/node_modules/mocha-loader/node_modules/css-loader/index.js!/Users/etiennelem/Code/new_ndex/node_modules/mocha/mocha.css", function() {
			var newContent = require("!!/Users/etiennelem/Code/new_ndex/node_modules/mocha-loader/node_modules/css-loader/index.js!/Users/etiennelem/Code/new_ndex/node_modules/mocha/mocha.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ndex, chai, helpers, simple;

	Ndex = __webpack_require__(24);

	simple = __webpack_require__(25);

	chai = __webpack_require__(26);

	chai.use(__webpack_require__(29));

	chai.config.truncateThreshold = 0;

	afterEach(function(done) {
	  var connection, name, promises;
	  simple.restore();
	  promises = (function() {
	    var ref, results;
	    ref = Ndex.connections;
	    results = [];
	    for (name in ref) {
	      connection = ref[name];
	      results.push(connection.deleteDatabase());
	    }
	    return results;
	  })();
	  return Promise.all(promises).then(function() {
	...
	helpers = {
	  delay: (function(_this) {
	    return function(duration, done, asserts) {
	      var ref;
	      if (!asserts) {
	        ref = [done, null], asserts = ref[0], done = ref[1];
	      }
	  ...
	  callbackSequence: function(callbacks) {
	    var fn;
	    fn = function() {
	      var returnValue;
	      returnValue = this._callbacks[this._nextIndex]();
	      if (this._nextIndex !== this._callbacks.length - 1) {
	        this._nextIndex += 1;
	      }
	      return returnValue;
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	factory = function() {
	  ...
	  Connection.API = (function() {
	    ...
	    API.prototype.parseMigrations = function(migrations1) {
	      var keys;
	      this.migrations = migrations1;
	      keys = Object.keys(this.migrations).sort();
	    ...
	    API.prototype.open = function() {
	      ...
	      return this.dbPromise = new Promise((function(_this) {
	        return function(resolve, reject) {
	          var request;
	          request = indexedDB.open(_this.name, Date.now());
	          request.onerror = function(e) {
	            return reject(e);
	          };
	          request.onupgradeneeded = function(e) {
	            var db, j, len, migration, migrationTransaction, migrations, results, transaction;
	            db = e.target.result;
	      ...
	      return new Promise((function(_this) {
	        return function(resolve) {
	          return _this.enqueue(readWrite, objectStoreName, function(transaction) {
	            var bound, bounds, count, eq, eqIsArray, exact, except, gt, gteq, hasValues, isEquivalent, isInclusive, isLowerBound, k, knownUniques, limit, lower, lt, lteq, offset, only, order, range, ref, remove, request, result, uniq, uniques, upper, v;
	            _this.logging.addRequest(transaction, 'where', objectStoreName, indexName, {
	              data: predicates
	            });
	            lt = predicates.lt, lteq = predicates.lteq, gt = predicates.gt, gteq = predicates.gteq, eq = predicates.eq, limit = predicates.limit, offset = predicates.offset, only = predicates.only, except = predicates.except, uniq = predicates.uniq, order = predicates.order, remove = predicates.remove;
	            ...
	            return request.onsuccess = function(e) {
	              var cursor, j, keyPath, knownValues, len, value;
	              if (!(cursor = e.target.result)) {
	                return resolve(result);
	              }
	              value = cursor.value;
	    ...
	    API.prototype.getMethodsForObjectStore = function() {
	      return this._getMethodsForObjectStore || (this._getMethodsForObjectStore = ['get', 'getAll', 'add', 'update', 'increment', 'decrement', 'delete', 'deleteWhere', 'clear', 'reset', 'index', 'where']);
	    };

	    API.prototype.getMethodsForIndex = function() {
	      return this._getMethodsForIndex || (this._getMethodsForIndex = ['get', 'getAll', 'where', 'deleteWhere']);
	    };
	  ...
	  Connection.Logging = (function() {
	    ...
	    Logging.prototype.use = function(logMethod, opts) {
	      this.opts = opts != null ? opts : {};
	      return this.logMethod = logMethod;
	    };
	    ...
	    Logging.prototype.addTransaction = function(transaction, objectStoreNames) {
	      ...
	      return transaction.addEventListener('error', callback);
	    };
	    ...
	    Logging.prototype.logTransaction = function(transaction) {
	      var data, end, groupMethod, indexName, j, key, len, logs, method, mode, objectStoreName, queue, ref, ref1, request, requestsLenght, time;
	      if (!this.logMethod) {
	        return;
	      }
	      queue = this.queues.filter(function(q) {
	      ...
	      console[groupMethod]('Ndex:', mode, queue.objectStoreNames, time + "ms", "(" + requestsLenght + " request" + (requestsLenght > 1 ? 's' : '') + ")");
	      ref = queue.requests;
	      for (j = 0, len = ref.length; j < len; j++) {
	        ...
	        console[this.logMethod].apply(console, logs);
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	Adapter = (function() {
	  ...
	  Adapter.prototype.proxyAPIMethods = function(objectStoreNames) {
	    var k, methods, v;
	    if (objectStoreNames == null) {
	      objectStoreNames = [];
	    }
	    ...
	    return methods.forEach((function(_this) {
	      return function(method) {
	        ...
	        return _this[method] = function() {
	          return _this.handleMethod.apply(_this, [method].concat(slice.call(arguments)));
	        };
	      };
	    })(this));
	  };

	  Adapter.prototype.index = function(objectStoreName, indexName) {
	    return this.connection.createNamespaceForIndex(indexName, objectStoreName, this);
	  };

	  Adapter.prototype.proxyObjectStoresNamespace = function(objectStoreNames) {
	    return this.connection.createNamespaceForObjectStores(objectStoreNames, this);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	BrowserAdapter = (function(superClass) {
	  extend(BrowserAdapter, superClass);

	  function BrowserAdapter() {
	    return BrowserAdapter.__super__.constructor.apply(this, arguments);
	  }

	  BrowserAdapter.prototype.handleMethod = function() {
	    var args, method;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Adapter, ConnectionRaw, WorkerAdapter, WorkerRaw,
	...
	ConnectionRaw = __webpack_require__(27);

	WorkerRaw = __webpack_require__(28);

	WorkerAdapter = (function(superClass) {
	  extend(WorkerAdapter, superClass);

	  function WorkerAdapter() {
	    this.handleMessage = bind(this.handleMessage, this);
	    WorkerAdapter.__super__.constructor.apply(this, arguments);
	    this.promises = {};
	    this.id = 1;
	    this.spawnWorker();
	  }

	  WorkerAdapter.prototype.spawnWorker = function() {
	    var blob, blobURL, k, migrations, name, ref, v;
	    ref = this.connection, name = ref.name, migrations = ref.migrations;
	    for (k in migrations) {
	      v = migrations[k];
	    ...
	    return console.info("Ndex: Worker for “" + name + "” spawned at " + blobURL);
	  };

	  WorkerAdapter.prototype.handleMethod = function() {
	    var args, id, method;
	    method = arguments[0], args = 2 <= arguments.length ? slice.call(arguments, 1) : [];
	    id = this.id++;
	    return new Promise((function(_this) {
	  ...
	  WorkerAdapter.prototype.handleMessage = function(e) {
	    var id, promise, ref, reject, resolve;
	    ref = e.data, id = ref.id, resolve = ref.resolve, reject = ref.reject;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BrowserAdapter, Connection, Ndex, WorkerAdapter;
	...
	Ndex = (function() {
	  ...
	  Ndex.prototype.connect = function(name, migrations) {
	    return new Promise((function(_this) {
	      return function(resolve, reject) {
	        var adapter, connection;
	        if (connection = _this.connections[name]) {
	          return reject(new Error("Already connected to “" + name + "”"));
	        }
	        connection = new Connection(name, migrations);
	        adapter = _this.connections[name] = _this.getAdapter(connection);
	        return adapter.handleMethod('open').then(function(objectStoreNames) {
	          adapter.proxyObjectStoresNamespace(objectStoreNames);
	  ...
	  Ndex.prototype.getAdapter = function(connection) {
	    var adapterClass;
	    adapterClass = this.getAdapterClass();
	    return new adapterClass(connection);
	  };

	  Ndex.prototype.getAdapterClass = function() {
	  ...
	  Ndex.prototype.workersAreSupported = function(scope) {
	    if (scope == null) {
	      scope = window;
	    }
	    return this._workersAreSupported != null ? this._workersAreSupported : this._workersAreSupported = 'Worker' in scope;
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(module) {(function (global, module) { // Browser compatibility
...
/***/ function(module, exports, __webpack_require__) {
	...
	var expect = __webpack_require__(34);
	exports.use(expect);
...
/***/ function(module, exports, __webpack_require__) {
	...
	migrations = {
	  '201412041358_CreateUsersObjectStore': function() {
	    return this.createObjectStore('users', {
	      keyPath: 'id',
	      autoIncrement: true
	    });
	  },
	  '201412041527_CreateOrganizationsObjectStore': function() {
	    return this.createObjectStore('organizations');
	  },
	  '201412041527_AddJobIndexToUsers': function() {
	    return this.createIndex('users', 'job', 'job');
	  }
	};
